...
const BlogArray = [
    {
        ...
        textBody: "The first feature I will develop is to allow users to track and store daily gratitudes. I want to have their gratitudes saved in MongoDB and have them access their history. After that, I will develop users to friend each other and see each other's gratitudes."
    },
    {
        postNum: 1,
